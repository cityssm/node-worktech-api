...
describe('queries/workOrders', () => {
    ...
    describe('getWorkOrders()', () => {
        it('Retrieves a work order', async () => {
            const workOrder = await _getWorkOrderByWorkOrderNumber(mssqlConfig, validWorkOrderNumber);
        ...
        it('Returns "undefined" when no work order is available.', async () => {
            const workOrder = await _getWorkOrderByWorkOrderNumber(mssqlConfig, invalidWorkOrderNumber);
            assert.strictEqual(workOrder, undefined);
        });
    });
    describe('getWorkOrderResources()', () => {
        it('Retrieves an array of resources', async () => {
            const resources = await _getWorkOrderResourcesByWorkOrderNumber(mssqlConfig, validWorkOrderNumber);
